    ...
    return (
        <div className="flex flex-col justify-start absolute top-5 left-2 border-b pr-28 border-gray-400 pb-6">
            ...
            <div className="flex flex-row justify-start items-center m-5 ">
                ...
                <p className="w-46 h-19 font-inter font-medium text-16 leading-19 text-gray-700">Home</p>
            </div>

            <div className="flex flex-row justify-start items-center m-5">
                <div className="w-10">

                    <svg width="116" height="24" viewBox="15 0 84 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <p className="w-46 h-19 font-inter font-medium text-16 leading-19 text-gray-700">Messages</p>
            </div>
            ...
            <div className="flex flex-row justify-start items-center m-5 ">
                ...
                <p className="w-46 h-19 font-inter font-medium text-16 leading-19 text-gray-700">Tasks</p>
            </div>
            ...
            <div className="flex flex-row justify-start items-center m-5 ">
                ...
                <p className="w-46 h-19 font-inter font-medium text-16 leading-19 text-gray-700">Members</p>
            </div>
            ...
            <div className="flex flex-row justify-start items-center m-5 ">
                ...
                <p className="w-46 h-19 font-inter font-medium text-16 leading-19 text-gray-700">Settings</p>
            </div>
        </div>
    )
}
